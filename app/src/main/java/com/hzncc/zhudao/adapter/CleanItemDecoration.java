...
public class CleanItemDecoration extends RecyclerView.ItemDecoration {
    private Drawable mDivider;


    public CleanItemDecoration(Context context) {
        super();
        mDivider = context.getResources().getDrawable(R.drawable.divider_clean_bg);
    }
