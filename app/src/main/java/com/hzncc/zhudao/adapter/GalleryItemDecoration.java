...
public class GalleryItemDecoration extends RecyclerView.ItemDecoration {
    ...
    public GalleryItemDecoration(Context context, List<AlarmLog> datas) {
        super();
        mDatas = datas;
        mPaint = new Paint();
        mBounds = new Rect();
    ...
    public void getItemOffsets(Rect outRect, View view, RecyclerView parent, RecyclerView.State state) {
        ...
        if (position > -1 && position < mDatas.size()) {
            ...
            if (hasTitle(position)) {
                Log.d("getItemOffs", "position " + position + " is inside");
                outRect.set(0, mTitleHeight, right, bottom);
            } else {
                Log.d("getItemOffs", "position " + position + " is not inside");
